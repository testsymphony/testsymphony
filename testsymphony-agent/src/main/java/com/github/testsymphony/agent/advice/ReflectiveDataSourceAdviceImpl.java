...
import com.github.testsymphony.agent.di.ApplicationContext;
...
public class ReflectiveDataSourceAdviceImpl {
    ...
    public static Object onExit(Object dataSource, Connection connection) {
        try {
            ...
            TSConnectionProxyFactory connectionProxyFactory = ApplicationContext.INSTANCE.get(TSConnectionProxyFactory.class);
