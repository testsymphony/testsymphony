 ...
 */
package com.github.ulyssesrr.testsymphonia.wiremock;
...
import com.github.ulyssesrr.testsymphonia.restmock.ProxyConnectionContextManager;
import com.github.ulyssesrr.testsymphonia.restmock.ProxyConnectionContextManager.ConnectionId;
...
public class CustomManInTheMiddleSslConnectHandler extends ConnectHandler {
  ...
  public CustomManInTheMiddleSslConnectHandler(ServerConnector mitmProxyConnector) {
    ...
    log.info("CustomManInTheMiddleSslConnectHandler IN USE");
  }
  ...
  protected void onConnectSuccess(ConnectContext connectContext, UpstreamConnection upstreamConnection) {
    ...
    ProxyConnectionContextManager.INSTANCE.put(connectionId, new ProxyConnectionContext(basicAuth.getFirst()));
  ...
  public static Pair<String, String> parseBasicAuth(String authHeader) {
        ...
        return Pair.of(parts[0], parts[1]); // username, password
    }
}
